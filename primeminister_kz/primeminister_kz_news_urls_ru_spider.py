...
class primeminister_kz_news_urls_ru(scrapy.Spider):
    name = "primeminister_kz_news_urls_ru"

    def start_requests(self):
        # общее количество страниц с новостями на сайте
        total_news_pages = 1626
        ...
        for i in range(total_news_pages + 1):
            urls.append("https://primeminister.kz/ru/news/page/" + str(i))
