...
class primeminister_kz_news_urls_en(scrapy.Spider):
    name = "primeminister_kz_news_urls_en"

    def start_requests(self):
        # общее количество страниц с новостями на сайте
        total_news_pages = 1130
        ...
        for i in range(total_news_pages + 1):
            urls.append("https://primeminister.kz/en/news/page/" + str(i))
